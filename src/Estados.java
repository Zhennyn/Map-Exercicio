...
public class Estados {
    ...
    public static void main(String[] args) {
        ...
        // Criando um Map de String para Siglas
        Map<String, Siglas> estados = new HashMap<>();

        // Populando o Map com objetos Siglas
        ...
        // Atualizando a população do RN
        estados.put("RN", new Siglas("RN", 3534165));

        // Imprimindo as entradas do Map novamente
        ...
        // Verificando se PB existe no dicionário
        System.out.println("PB está no dicionário? " + estados.containsKey("PB"));
        System.out.println("--------------------");

        // Adicionando PB ao dicionário
        estados.put("PB", new Siglas("PB", 4039277));

        // Verificando se PB existe no dicionário novamente
        System.out.println("PB está no dicionário? " + estados.containsKey("PB"));
        System.out.println("--------------------");

        // Imprimindo as entradas do Map novamente (com PB)
        ...
        Set<Map.Entry<String, Siglas>> estadosOrdenadosPorPopulacao = new TreeSet<>(new ComparatorPopulacao());
